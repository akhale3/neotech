...
<div id="wrapper">
	 ...
	 session_start();
		...
		echo "
		<div id=\"navigation\">
                <ul><li id='pg845949173236651697'><a href='index.php'>Home</a></li><li id='active'><a href='product.php'>Products</a></li><li id='pg868788968560658166'><a href='cart.php'>Cart</a></li><li id='pg918166139978388689'><a href='about.php'>About</a></li><li id='pg998940121782619229'><a href='contact.php'>Contact</a></li><li id='pg229832568129951258'><a href='logout.php'>Logout</a></li></ul>
            </div>
		";
		}
		?>
        <div id="header" class="wsite-header">
            ...
            <div id="content">
                ...
                <form action="<?php echo basename($_SERVER['PHP_SELF']); ?>" method="get" name="rahul">
