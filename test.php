...
?>
<table name="search_tab" border="0" cellspacing="20" cellpadding="5">
<th>Product No.</th><th>Product Name</th><th>Category</th><th>Price</th><th>Company</th><th>Image</th><th>Details</th>
<?php
do
{
	echo "<tr>";
	//echo $row['image'];
	echo "<td>".$row['pro_no']."</td>"."<td>".$row['pro_name']."</td>"."<td>".$row['category']."</td>"."<td>"."Rs. ".$row['price']."</td>"."<td>".$row['company']."</td>"."<td>"."<img src=\"".$row['image']."\" />"."</td>"."<td>".$row['details']."</td>";
	echo "</tr>";
}
