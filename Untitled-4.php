...
<div id="wrapper">
	 ...
	 session_start();
		...
		echo "
		<div id=\"navigation\">
                <ul><li id='pg845949173236651697'><a href='index.php'>Home</a></li><li id='active'><a href='product.php'>Products</a></li><li id='pg868788968560658166'><a href='cart.php'>Cart</a></li><li id='pg918166139978388689'><a href='about.php'>About</a></li><li id='pg998940121782619229'><a href='contact.php'>Contact</a></li><li id='pg443915658588257973'><a href='legal.php'>Legal</a></li><li id='pg814732842815426025'><a href='sitemap.php'>Sitemap</a></li><li id='pg552290307214122016'><a href='help.php'>Help</a></li><li id='pg229832568129951258'><a href='logout.php'>Logout</a></li></ul>
            </div>
		";
		}
		?>
...
<div ><div class="wsite-form-field" style="margin:0px 0px 0px 0px;"></div></div>
  <label class="wsite-form-label" for="input-488535060959664633"><h3>SORT BY</h3></label>
...
<div id="txtHint"><b>Person info will be listed here.</b></div>
                  ...
                  <div id="917773219333532109-parent" class="wsite-splitpane-2" style="width: 100%;">
...
<?php
            //show records
            $query = mysql_query("SELECT * FROM products LIMIT {$startpoint} , {$limit}");
