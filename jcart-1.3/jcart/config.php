...
$config['item']['id']             = $row['pro_no'];    // Item id
$config['item']['name']           = $row['pro_name'];    // Item name
$config['item']['price']          = $row['price'];    // Item price
//$config['item']['qty']            = 'my-item-qty';    // Item quantity
//$config['item']['url']            = 'my-item-url';    // Item URL (optional)
$config['item']['add']            = 'add_cart';    // Add to cart button
